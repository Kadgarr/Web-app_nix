...
namespace BL.Mapping
{
    public class AutoMapperProfile: Profile
    {
        ...
        {
            CreateMap<User, UserDTO>().ReverseMap()/*.ForMember(dest => dest.Email, opt => opt.MapFrom(src => src.Email))
                .ForMember(dest => dest.Login, opt => opt.MapFrom(src => src.Login))
                .ForMember(dest => dest.Password, opt => opt.MapFrom(src => src.Password))
                .ForMember(dest => dest.UserId, opt => opt.MapFrom(src => src.UserId))*/;
            CreateMap<Album, AlbumDTO>().ReverseMap()/*.ForMember(dest => dest.AlbumId, opt => opt.MapFrom(src => src.AlbumId))
            ...
            CreateMap<Genre, GenreDTO>().ReverseMap()/*.formember(dest => dest.genreid, opt => opt.mapfrom(src => src.genreid))
                .formember(dest => dest.name_of_genre, opt => opt.mapfrom(src => src.name_of_genre))*/;
            CreateMap<Singer, SingerDTO>().ReverseMap()/*.ForMember(dest => dest.SingerId, opt => opt.MapFrom(src => src.SingerId))
            ...
            CreateMap<Song, SongDTO>().ReverseMap()/*.ForMember(dest => dest.SongId, opt => opt.MapFrom(src => src.SongId))
            ...
            CreateMap<Playlist, PlaylistDTO>().ReverseMap()/*.ForMember(dest => dest.PlaylistId, opt => opt.MapFrom(src => src.PlaylistId))
            ...
            CreateMap<Genres_of_Music, Genres_of_MusicDTO>().ReverseMap()/*.ForMember(dest => dest.GenreId, opt => opt.MapFrom(src => src.GenreId))
            ...
            CreateMap<Playlist_of_User, Playlist_of_UserDTO>().ReverseMap()/*.ForMember(dest => dest.PlaylistId, opt => opt.MapFrom(src => src.PlaylistId))
                .ForMember(dest => dest.SongId, opt => opt.MapFrom(src => src.SongId))
                .ForMember(dest => dest.UserId, opt => opt.MapFrom(src => src.UserId))

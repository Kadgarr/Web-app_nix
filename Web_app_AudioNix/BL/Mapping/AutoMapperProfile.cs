...
namespace BL.Mapping
{
    public class AutoMapperProfile: Profile
    {
        ...
        {
            CreateMap<User, UserDTO>().ForMember(dest => dest.Email, opt => opt.MapFrom(src => src.Email))
                .ForMember(dest => dest.Login, opt => opt.MapFrom(src => src.Login))
                .ForMember(dest => dest.Password, opt => opt.MapFrom(src => src.Password))
                .ForMember(dest => dest.UserId, opt => opt.MapFrom(src => src.UserId));
            CreateMap<Album, AlbumDTO>().ForMember(dest => dest.AlbumId, opt => opt.MapFrom(src => src.AlbumId))
            ...
            CreateMap<Genre, GenreDTO>().ForMember(dest => dest.GenreId, opt => opt.MapFrom(src => src.GenreId))
                .ForMember(dest => dest.Name_of_Genre, opt => opt.MapFrom(src => src.Name_of_Genre));
            CreateMap<Singer, SingerDTO>().ForMember(dest => dest.SingerId, opt => opt.MapFrom(src => src.SingerId))
            ...
            CreateMap<Song, SongDTO>().ForMember(dest => dest.SongId, opt => opt.MapFrom(src => src.SongId))
            ...
            CreateMap<Playlist, PlaylistDTO>().ForMember(dest => dest.PlaylistId, opt => opt.MapFrom(src => src.PlaylistId))
            ...
            CreateMap<Genres_of_Music, Genres_of_MusicDTO>().ForMember(dest => dest.GenreId, opt => opt.MapFrom(src => src.GenreId))
            ...
            CreateMap<Playlist_of_User, Playlist_of_UserDTO>().ForMember(dest => dest.PlaylistId, opt => opt.MapFrom(src => src.PlaylistId))
                .ForMember(dest => dest.SongId, opt => opt.MapFrom(src => src.SongId))
                .ForMember(dest => dest.UserId, opt => opt.MapFrom(src => src.UserId))
